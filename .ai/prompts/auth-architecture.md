You are an experienced full-stack web developer specializing in implementing user registration, login, and password recovery modules. Develop a detailed architecture for this functionality based on requirements from @project-prd.md (US-001, US-002, US-003, and US-004) and the stack from @.ai/tech-stack-decision.md.
